...
$(function () {
  ...
  if($(".chart.header-bar").length){
    $('.chart.header-bar').sparkline([7, 5, 3, 8, 4, 2, 7, 5, 6], {
      type: 'bar',
      barColor: '#6f42c1',
      negBarColor: '#fff',
      barWidth: '4px',
  ...
  if($(".chart.header-bar2").length){
    $('.chart.header-bar2').sparkline([7, 5, 3, 8, 4, 2, 7, 5, 6], {
        type: 'bar',
        barColor: '#ff0090',
        negBarColor: '#fff',
        barWidth: '4px',
  ...
  $(".layout-color input:radio").change(function () {
    if ($(this).val() == "1") {
      ...
      $(".layout-color input[value|='1']").prop("checked", true);
    } else {
      $('body').removeClass();
      $('body').addClass('dark');
      ...
      $(".layout-color input[value|='2']").prop("checked", true);
    }
  });
